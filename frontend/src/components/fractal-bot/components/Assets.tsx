...
export function Assets({ className = '', assets }: AssetsProps) {
    return (
        <div className={`flex flex-col h-full bg-white/95 dark:bg-gray-800/95 ${className}`}>
            <div className="px-4 py-3 border-b dark:border-gray-700">
                <h2 className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Assets</h2>
            </div>
                    ...
                    {assets.map((asset) => (
                        ...
                        >
                            ...
                            <div className="ml-3 flex-1">
                                <div className="text-sm font-medium text-gray-700 dark:text-gray-300">{asset.name}</div>
